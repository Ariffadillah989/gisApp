        ...
        <div class="solution_cards_box">
          <div class="solution_card">
            ...
            <div class="solu_description">
              <p>
                terdapat beberapa ruang rawat inap pada Rumah Sakit IbnuSina
              </p>
              <button onclick="window.location.href='/detailruangibnu';" type="button" class="read_more_btn" >Baca Selengkapnya</button>
            </div>
          </div>
          <div class="solution_card">
            <div class="hover_color_bubble"></div>
            ...
            <div class="solu_description">
              <p>
                klik baca selengkapnya untuk melihat program yang diadakan rumah sakit Ibnu Sina
              </p>
        ...
        <div class="solution_cards_box sol_card_top_3">
          <div class="solution_card">
            ...
            <div class="solu_description">
              ...
              <button onclick="window.location.href='https://arest.web.id/content/rumah-sakit-islam-ibnu-sina-sigli';" type="button" class="read_more_btn">Baca Selengkapnya</button>
            </div>
          </div>
        </div>
      </div>
