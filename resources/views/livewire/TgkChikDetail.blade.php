      ...
      <div class="our_solution_category">
        <div class="solution_cards_box">
          <div class="solution_card">
            ...
            <div class="solu_description">
              <p>
                terdapat beberapa ruang rawat inap pada Rumah Sakit Tengku Chik ditiro 
              </p>
              <button onclick="window.location.href='/detailruangtgkchik';" type="button" class="read_more_btn" formaction="/detailruangtgkchik">Baca Selengkapnya</button>
            </div>
          </div>
          <div class="solution_card">
            <div class="hover_color_bubble"></div>
            ...
            <div class="solu_title">
              <h3>Program Faskes</h3>
            </div>
            <div class="solu_description">
              <p>
                klik baca selengkapnya untuk melihat program yang diadakan rumah sakit tgk chik ditiro
              </p>
              <button type="button" class="read_more_btn">Baca selengkapnya</button>
            </div>
          </div>
        </div>
        <!--  -->
        <div class="solution_cards_box sol_card_top_3">
          <div class="solution_card">
            ...
            <div class="solu_description">
              <p>
                Klik baca selengkapnya untuk menuju website resmi rumah sakit
              </p>
              <button onclick="window.location.href='https://rsudtcd.pidiekab.go.id/';" type="button" class="read_more_btn" formaction="/detailruangtgkchik">Baca Selengkapnya</button>
            </div>
          </div>
        </div>
      </div>
