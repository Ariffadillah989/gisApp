            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form
                        ...
                        <div class="form-group">
                            <label>Menerima Resep Dokter</label>
                            <textarea wire:model="resep" class="form-control"></textarea>
                            @error('resep') <small class="text-danger">{{$message}}</small> @enderror
                        </div>
                        <div class="form-group">
                            <label>Jenis</label>
        ...
        document.addEventListener('livewire:load', () => {
            ...
            const loadLocations = (geoJsonApt) => {
                geoJsonApt.features.forEach((location) => {
                    ...
                    const {iconSize, locationId, title, image, description, type, jenis, resep} = properties
