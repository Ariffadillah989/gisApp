...
<h1 style="text-align:center;">Rumah Sakit Mufid</h1>
        ...
        <div class="solution_cards_box">
          <div class="solution_card">
            ...
            <div class="solu_description">
              <p>
                terdapat beberapa ruang rawat inap pada Rumah Sakit Mufid
              </p>
              <button onclick="window.location.href='/detailruangmufid';" type="button" class="read_more_btn" >Baca Selengkapnya</button>
            </div>
          </div>
          <div class="solution_card">
            <div class="hover_color_bubble"></div>
            ...
            <div class="solu_description">
              <p>
                klik baca selengkapnya untuk melihat program yang diadakan rumah sakit Mufid
              </p>
        ...
        <div class="solution_cards_box sol_card_top_3">
          <div class="solution_card">
            ...
            <div class="solu_description">
              ...
              <button onclick="window.location.href='https://rsu-mufid-sigli.business.site/';" type="button" class="read_more_btn">Baca Selengkapnya</button>
            </div>
          </div>
        </div>
      </div>
